...
function mountLoader() {
  ...
  loader.innerHTML = `
    ...
    <div class="loader-text" id="loader-message">${LOADER_MESSAGES[0]}</div>
  ...
  loaderInterval = setInterval(() => {
    ...
    if (msg) msg.textContent = LOADER_MESSAGES[i];
  }, 1400);
}
...
emptyState.innerHTML = `
  <div class="collection-loading">
    ...
    <p>Fetching selected work. Please wait a moment.</p>
  </div>
`;
